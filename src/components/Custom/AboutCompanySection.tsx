...
export default function AboutCompanySection() {
  const coreValues = [
    { title: "Innovation", desc: "We constantly evolve and innovate to stay ahead of the curve." },
    { title: "Integrity", desc: "We build trust through transparency, reliability, and commitment." },
    { title: "Collaboration", desc: "We believe great results come from strong partnerships." },
    { title: "Excellence", desc: "We deliver high-quality solutions that exceed expectations." },
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-20">
        ...
        >
          <div>
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-300 leading-relaxed">
              Our team of passionate technologists, designers, and strategists brings deep expertise across IT staffing,
              consulting, cloud computing, AI integration, and full-stack digital platforms.
            </p>
          </div>
          <Card className="bg-white/60 dark:bg-[#111]/60 backdrop-blur-md border border-slate-200 dark:border-white/10 shadow-md">
            <CardContent className="p-6 text-center">
              <h4 className="text-xl font-semibold mb-2 text-blue-500">Our Philosophy</h4>
              <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                We combine creativity, strategy, and technology to empower businesses with transformative digital
                solutions.
              </p>
            </CardContent>
          </Card>
        ...
        >
          <Card className="p-8 bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 hover:shadow-lg hover:-translate-y-1 transition-all">
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              To transform ideas into impactful digital realities. We empower businesses through technology innovation,
              strategic consulting, and world-class execution to ensure long-term growth and success.
            </p>
          </Card>

          <Card className="p-8 bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 hover:shadow-lg hover:-translate-y-1 transition-all">
            <h3 className="text-2xl font-bold text-blue-500 mb-3">Our Vision</h3>
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              To become a global leader in delivering intelligent, scalable, and future-ready digital solutions, setting
              new benchmarks for excellence in the IT industry.
            </p>
          </Card>
        </motion.div>
            ...
            {coreValues.map((val, i) => (
              ...
              >
                <Card className="h-full bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 hover:shadow-md transition-all">
                  <CardContent className="p-6 text-center">
                    <h4 className={cn("text-xl font-semibold mb-2", i % 2 === 0 ? "text-orange-500" : "text-blue-500")}>
                      {val.title}
                    </h4>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">{val.desc}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
        ...
        >
          <div className="bg-white dark:bg-[#0c0c0c] rounded-3xl p-10 md:p-16 text-center border border-slate-200 dark:border-white/10">
            ...
            <p className="max-w-3xl mx-auto text-slate-600 dark:text-slate-300 leading-relaxed">
              We don’t just build solutions — we build relationships. Our customer-centric approach ensures every project
              aligns with your vision and business goals. With a proven record of innovation and excellence, Ziostech
              Solution stands as your trusted partner in digital transformation.
            </p>
          </div>
        </motion.div>
