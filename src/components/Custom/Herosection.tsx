...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  subtitle = "Ziostech Solution delivers expert IT consulting, staffing, web & app development, and AI integration services to help businesses grow and innovate.",
